...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.static',  # Adiciona o context processor para static
            ],
        },
    },
]
...
LOGIN_REDIRECT_URL = '/garage/home'  # Corrigido o redirecionamento após o login
